...
public class Resize {
     ...
     */
    public static void margin(javafx.scene.Node no, double top, double right, double bottom, double left) {
     ...
     */
    public static void margin(javafx.scene.Node no, double valor) {
     ...
     */
    public static void margin(javafx.scene.Node no, double top, double right, double left) {
        AnchorPane.setTopAnchor(no, top);
        AnchorPane.setRightAnchor(no, right);
        AnchorPane.setLeftAnchor(no, left);
    }
     ...
     */
    public static void margin(javafx.scene.Node no, double right, double left) {
        AnchorPane.setRightAnchor(no, right);
        AnchorPane.setLeftAnchor(no, left);
    }
     ...
     */
    public static void marginTop(javafx.scene.Node no, double top) {
        AnchorPane.setTopAnchor(no, top);
    }
     ...
     */
    public static void marginRight(javafx.scene.Node no, double right) {
        AnchorPane.setRightAnchor(no, right);
    }
     ...
     */
    public static void marginBottom(javafx.scene.Node no, double bottom) {
        AnchorPane.setBottomAnchor(no, bottom);
    }
